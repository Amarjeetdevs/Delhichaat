...
$(document).ready(function () {
  ...
  $(".product-box-layout4").click(function () {
    ...
    if ($(this)[0].className.search("thali productClicked") > -1) {
      $("#thali").show().siblings("div").hide();

      $("html, body").animate(
        {
          scrollTop: $("#thali").offset().top,
        },
        800,
        function () { }
      );
    ...
    } else if ($(this)[0].className.search("main productClicked") > -1) {
    ...
    } else if ($(this)[0].className.search("bread productClicked") > -1) {
      $("#bread").show().siblings("div").hide();
    ...
    } else if ($(this)[0].className.search("rice productClicked") > -1) {
      $("#rice").show().siblings("div").hide();

      $("html, body").animate(
        {
          scrollTop: $("#rice").offset().top,
        },
        800,
        function () { }
      );
    } else if ($(this)[0].className.search("fried productClicked") > -1) {
      $("#fried").show().siblings("div").hide();

      $("html, body").animate(
        {
          scrollTop: $("#fried").offset().top,
        },
        800,
        function () { }
      );
    } else if ($(this)[0].className.search("rolls productClicked") > -1) {
      $("#rolls").show().siblings("div").hide();

      $("html, body").animate(
        {
          scrollTop: $("#rolls").offset().top,
        },
        800,
        function () { }
      );
    } else if ($(this)[0].className.search("accom productClicked") > -1) {
      $("#accom").show().siblings("div").hide();

      $("html, body").animate(
        {
          scrollTop: $("#accom").offset().top,
        },
        800,
        function () { }
      );
    } 
    else if ($(this)[0].className.search("dessert productClicked") > -1) {
      $("#dessert").show().siblings("div").hide();
    ...
    else if ($(this)[0].className.search("xyz productClicked") > -1) {
      $("#xyz").show().siblings("div").hide();
...
function openWhatsapp() {
  ...
  if ($("#address")[0].value === "") {
    ...
    window.open("https://wa.me/+917483350681?text=" + wTxtEncoded);
  }
}
